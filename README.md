...
[**Live Demo**](https://vue-tagsinput.james090500.workers.dev/)
...
```html
<tags-input element-id="tags" v-model="selectedTags"></tags-input>
```
...
Everyone is welcome to contribute. Thank you!
